                ...
                <Content>
                    <View style = {{flexDirection: 'row', height: height/5}}>
                        <View style = {{
                            ...
                            <Text style = {{color: 'red',justifyContent: 'center', alignSelf: 'center', fontSize: 40, marginTop: 20}}>-S$50.0</Text>
                        </View>
                        <View style = {{
                            width: width/2,
                            borderColor: 'lightgray',
                            ...
                            <Text style = {{color: 'green',justifyContent: 'center', alignSelf: 'center', fontSize: 40, marginTop: 20}}>+S$200.0</Text>
                        </View>
                    </View>
